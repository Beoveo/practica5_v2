...
public class MainPr4 {
	...
	public static void match(GameState<?, ?> initialState, GamePlayer player0, GamePlayer player1, int times) {
		...
		players.add(player0); //Incluye en la lista el jugador 0 y 1.
		players.add(player1); 
	...
	/**
	 * Metodo statico toString que muestra por pantalla un texto que pide el tipo de jugador.
	 * @param cont: Lleva la cuenta del jugador al que se refiere.
	 */
	public static void playerTypeToString(int cont){
		System.out.println("Tipo de jugador para jugador "+ cont +" :" + System.getProperty("line.separator") 
				+ "		Por consola => CONSOLE." + System.getProperty("line.separator") + "		Aleatorio => RAND." + System.getProperty("line.separator")
				+ "		Inteligente => SMART." + System.getProperty("line.separator") + ">");
	}
