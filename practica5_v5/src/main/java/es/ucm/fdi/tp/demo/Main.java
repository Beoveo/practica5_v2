...
public class Main {
	...
	public static void main(String... args) {
		...
		//match(new WolfAndSheepState(8), new RandomPlayer("Bea"), new SmartPlayer("Alberto", 5), 1); //gana la oveja
		match(new WolfAndSheepState(8), new SmartPlayer("Alberto", 5), new RandomPlayer("Bea"), 1); //gana lobo
	}
	*/
}
